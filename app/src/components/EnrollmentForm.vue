      ...
      <div class="col-12 col-md-6">
        ...
        <form v-if="formSubmissionState === FORM_SUB_STATE.EDIT" @submit.prevent="submitForm">
          <div class="mb-4">
            <div>
              <div>
                <b>Data:</b> 26 e 27 de setembro de 2026 <b>(inscrições prorrogadas até 19/09/2026)</b>.
              </div>
              <div>
                <ul>
            ...
            <div class=" alert alert-info text-center my-5">
              ...
              <div class="d-flex justify-content-center">
                ...
                <a
                  class="btn btn-primary mx-2" target="_blank"
                  href="https://chat.whatsapp.com/HMkgS0UDdUfCYFxGxKxcFp"
                >
                  <i class="bi bi-whatsapp"></i> Entrar na comunidade do WhatsApp
                </a>
              </div>
            </div>
          </div>
          ...
          <div class="mt-3 mb-3">
            <label for="gender" class="form-label">Sexo (apenas para fins de escolha de modalidade)</label>
            <div class="input-group">
